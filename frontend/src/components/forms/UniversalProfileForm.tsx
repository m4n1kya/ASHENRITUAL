        ...
        <div className="absolute -bottom-6 left-6 group/avatar">
          <div className="w-16 h-16 rounded-full border-2 border-[#0a0a0a] bg-[#1A1A1A] overflow-hidden relative shadow-xl">
            {profile?.avatar ? (
              ...
              /* eslint-disable-next-line @next/next/no-img-element */
              <img src="/images/default-avatar.png" alt="Avatar" className="w-full h-full object-contain p-2 group-hover/avatar:opacity-40 transition-opacity bg-gradient-to-br from-[#1A1A1A] to-[#2A2A2A]" />
            )}
