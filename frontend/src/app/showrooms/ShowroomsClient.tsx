...
const FALLBACK_SHOWROOMS: Showroom[] = [
  ...
  },
  {
    ...
    state: 'Maharashtra',
    city: 'Mumbai',
    description: 'India\'s largest pop culture merchandise destination, bringing fandom to life.',
    history: null,
  ...
  },
  {
    ...
    state: 'Delhi',
    city: 'New Delhi',
    description: 'Global fashion brand offering the latest styles and inspiration for all.',
    history: null,
  ...
  },
  {
    ...
    state: 'Karnataka',
    city: 'Bangalore',
    description: 'Tata\'s premier retail destination offering exclusive brands and contemporary fashion.',
    history: null,
    specialization: 'Contemporary Indian & Western wear',
    knownFor: 'Nuon & Utsa collections',
    image: 'https://images.unsplash.com/photo-1582015752624-e8b1c75e3711?q=80&w=1000&auto=format&fit=crop',
    logo: null,
    verification: 'verified',
    hours: '11 AM - 9 PM'
  },
  {
    ...
    state: 'Maharashtra',
    city: 'Mumbai',
    description: 'One of the largest international fashion companies, keeping up with the latest trends.',
    history: null,
  ...
  },
  {
    ...
    state: 'Hong Kong',
    city: 'Hong Kong',
    description: 'An international destination for classic artisanal menswear and bespoke tailoring.',
    history: null,
  ...
  },
  {
    ...
    state: 'North Holland',
    city: 'Amsterdam',
    description: 'European brand renowned for its expertly crafted men\'s suits and modern tailoring.',
    history: null,
