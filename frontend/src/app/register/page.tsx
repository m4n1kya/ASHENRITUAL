  ...
  return (
    ...
    >
      <div className="mb-10 text-center">
        <Link href="/" className="font-heading text-xl tracking-[0.3em] text-foreground">
          ASHENRITUAL
        </Link>
        <h1 className="mt-6 font-heading text-2xl uppercase tracking-widest text-foreground">
          Join The Ritual
        </h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        {[
          ...
          <div key={name}>
            ...
            <input
              ...
              className={cn(
                'w-full border bg-background px-4 py-2.5 text-xs text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-1',
        ...
        <button
          type="submit"
          disabled={loading}
          className="mt-2 flex h-10 w-full items-center justify-center gap-3 border border-[#E8E8E8]/20 bg-transparent text-[10px] font-medium uppercase tracking-widest text-[#E8E8E8] transition-all hover:bg-[#E8E8E8] hover:text-[#0A0A0A] disabled:opacity-70"
        >
