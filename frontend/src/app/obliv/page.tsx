...
export default function VesperPage() {
  ...
  async function handleSubmit(
    ...
    if (!token) {
      toast.error("Sign in to consult VESPER.", {
        description: "Your wardrobe intelligence awaits.",
      });
      return;
    }
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "vesper", content: res.response },
      ]);
    } catch {
      setMessages((prev) => [
        ...prev,
        ...
        <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col px-6 py-12 lg:px-0">
          ...
          >
            ...
            {!hasMessages && (
              ...
              >
                VESPER observes. VESPER analyzes. VESPER refines. Share your
                occasion, and receive a wardrobe direction built on restraint.
              </motion.p>
            )}
          </div>
