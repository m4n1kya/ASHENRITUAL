 ...
 * @module SizeRecommendationClient.tsx
 */
"use client";
        ...
        <div className="relative z-10 flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex items-center justify-between mb-2">
              <span className="text-[9px] uppercase tracking-[0.3em] text-[#8D8D8D]">
                Vesper Size Intelligence
              </span>
            ...
            <p className="font-heading text-lg text-[#E8E8E8] mb-1">
              Recommended:{" "}
              <span className="text-[#FDFCFB]">SIZE {recommendedSize}</span>
            </p>

            <p className="text-[11px] text-[#8D8D8D] leading-relaxed italic border-l border-[#333] pl-3 mt-3">
              &quot;Based on your {profile.bodyType} profile, this garment will
              provide an ideal shoulder fit with a{" "}
              {profile.preferredFit === "Slim" ? "tapered" : "slightly relaxed"}{" "}
              chest.&quot;
            </p>
          </div>
        </div>
