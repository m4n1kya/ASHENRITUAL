    ...
    try {
      ...
      await vesperApi.chatStream(
        ...
        (jsonData) => {
          ...
          const updates: Parameters<typeof updateMessage>[1] = {
            isStreaming: false,
          };
          if (jsonData.recommendations)
            updates.recommendations = jsonData.recommendations;
      ...
      const errMsg =
        typeof err === "string" && err.includes("Session expired")
          ...
          >
            <div className="flex items-center justify-between gap-3 border border-[rgba(255,255,255,0.05)] bg-white/[0.02] px-4 py-2.5 rounded-xl">
              <p className="text-[11px] text-[#4A4A4A]">
                Sign in for personalised styling, saved history &amp; full
                Vesper intelligence.
              </p>
              <Link
                href="/login?redirect=/vesper"
                ...
                >
                  {QUICK_PROMPTS.map((prompt, i) => (
                    ...
                    >
                      ...
                      <span className="text-[12px] text-[#3A3A3A] group-hover:text-[#9A9A9A] transition-colors">
                        {prompt}
                      </span>
                    </motion.button>
                  ))}
      ...
      <div className="relative z-20 shrink-0 px-6 pb-8 pt-3">
        <div className="max-w-2xl mx-auto">
          ...
          <AnimatePresence>
            {isLoading && (
              ...
              >
                ...
                <span className="text-[9px] uppercase tracking-widest text-[#222]">
                  Vesper is thinking
                </span>
              </motion.div>
            )}
          ...
          <p className="text-center text-[9px] text-[#1A1A1A] mt-3 tracking-widest uppercase">
            Vesper may occasionally be imperfect. Verify important styling
            choices.
          </p>
        </div>
      </div>
