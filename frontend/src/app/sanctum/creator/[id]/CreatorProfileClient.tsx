...
export function CreatorProfileClient({ creatorId: _creatorId }: { creatorId: string }) {
  ...
  const creator = {
    ...
    philosophy: 'Fashion is not merely about covering the body, but structuring it. I believe in designing garments that act as a rigid, enduring second skin. My process rejects seasonal obsolescence in favor of permanent, monolithic concepts.',
    avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1974&auto=format&fit=crop',
    banner: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?q=80&w=1972&auto=format&fit=crop',
  };
      ...
      <section className="w-full py-16 px-6 lg:px-12 mx-auto max-w-screen-2xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <div className="lg:col-span-4 space-y-12">
            <div>
              <h1 className="font-heading text-4xl lg:text-5xl uppercase tracking-wider text-[#FDFCFB] mb-2">{creator.name}</h1>
            ...
            <div className="p-8 border border-[rgba(255,255,255,0.05)] bg-[#050505]">
              <h3 className="font-heading text-[10px] uppercase tracking-[0.3em] text-[#8D8D8D] mb-6">Affiliated Showrooms</h3>
              <Link href="/showrooms/shr_01" className="group block">
                <div className="flex items-center justify-between border-b border-[rgba(255,255,255,0.05)] pb-4">
                  <div>
                    <p className="font-heading text-sm uppercase tracking-widest text-[#E8E8E8] group-hover:text-[#FDFCFB] transition-colors">Atelier Kuro</p>
                    <p className="font-mono text-[9px] uppercase tracking-widest text-[#4A4A4A] mt-1">Pithoragarh</p>
                  </div>
          ...
          <div className="lg:col-span-8 lg:pl-12">
            <h2 className="font-display italic text-3xl text-[#FDFCFB] mb-6">The Manifesto</h2>
            ...
            <div className="space-y-24">
              ...
              {/* Concept Section */}
              <div>
                <h3 className="font-heading text-lg uppercase tracking-widest text-[#FDFCFB] mb-8 border-b border-[rgba(255,255,255,0.05)] pb-4">Prototype Archive</h3>
                  ...
                  {[1,2,3,4].map(i => (
                    <div key={i} className="group cursor-pointer">
                      <div className="aspect-[3/4] bg-[#0A0A0A] overflow-hidden mb-4 border border-[rgba(255,255,255,0.02)] group-hover:border-[rgba(255,255,255,0.1)] transition-colors">
                        <div className="w-full h-full bg-[#111] animate-pulse" /> {/* Placeholder Image */}
                      </div>
                      <p className="font-heading text-xs uppercase tracking-widest text-[#E8E8E8] group-hover:text-[#FDFCFB]">Prototype 00{i}</p>
                      <p className="font-mono text-[9px] tracking-widest text-[#4A4A4A] mt-1 uppercase">Not for sale</p>
                    </div>
                  ))}
                </div>
              </div>
