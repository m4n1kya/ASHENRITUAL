    ...
    const chapters = await Promise.all([
        ...
        prisma.chapter.upsert({
            ...
            create: {
                ...
                image: '/images/products/cmm14610_black_xl.webp',
            },
        }),
        prisma.chapter.upsert({
            where: { name: 'Epoch' },
    ...
    const products = await Promise.all([
        prisma.product.create({
            data: {
                ...
                price: 4999,
                images: ['/images/products/cmm24428_black_xl.webp'],
                stock: 35,
        ...
        prisma.product.create({
            data: {
                ...
                price: 3499,
                images: ['/images/products/cmm25434_black_xl.webp'],
                stock: 42,
                categoryId: shirts.id,
            },
        }),
        prisma.product.create({
            data: {
                ...
                price: 3999,
                images: ['/images/products/dennison_navy_shirt.jpg'],
                stock: 28,
                categoryId: shirts.id,
            },
        }),
        prisma.product.create({
            data: {
                ...
                price: 5499,
                images: ['/images/products/trouser_1.png'],
                stock: 20,
        ...
        prisma.product.create({
            data: {
                ...
                price: 12999,
                images: ['/images/products/cmm14610_black_xl.webp'],
                stock: 12,
        ...
        prisma.product.create({
            data: {
                ...
                price: 7999,
                images: ['/images/products/bmm91526_black_xl.webp'],
                stock: 18,
                categoryId: outerwear.id,
            },
        }),
        prisma.product.create({
            data: {
                ...
                price: 8999,
                images: ['/images/products/cmm28233_black_xl.webp'],
                stock: 15,
                categoryId: outerwear.id,
            },
        }),
        prisma.product.create({
            data: {
                ...
                price: 9499,
                images: ['/images/products/footwear_1.png'],
                stock: 22,
